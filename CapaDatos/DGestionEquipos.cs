...
namespace CapaDatos
{
    public class DGestionEquipos
    {
        ...
        public string RecepcionEquipos2(DGestionEquipos ges)
        {
            ...
            try
            {
                ...
                sqlCmd.Connection = SqlCon.Conectarbd;
                sqlCmd.CommandText = "sp_RecepcionMov2";
                sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        //Metodo para mostrar los estados de la tabla
        public DataTable MostrarE()
        {
            DataTable DtResultado = new DataTable("movimientos_enquipos");
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                SqlCon.ConnectionString = Conexion.Cn;
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "spmostrar_estados_mov";
                SqlCmd.CommandType = CommandType.StoredProcedure;
